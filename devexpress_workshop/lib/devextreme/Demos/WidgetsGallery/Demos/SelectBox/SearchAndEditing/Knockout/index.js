window.onload = function() {
    var currentProduct = ko.observable(simpleProducts[0]),
        productsDataSource = new DevExpress.data.DataSource(simpleProducts),
    ...
    var viewModel = {
        currentProductName: ko.computed(function() { return currentProduct().Name }),
        currentProductId: ko.computed(function() { return currentProduct().ID }),
        searchBoxOptions: {
            dataSource: products,
            displayExpr: "Name",
            searchEnabled: true,
