...
function Item({ text, handle, style }) {
  ...
  return <div
    ...
    style={style}>
    {handle &&
      <i className="handle dx-icon dx-icon-dragvertical"></i>
    }
    {text}
  </div>;
}
...
class App extends React.Component {
      ...
      <div id="demo-container">
        ...
        <div className="options">
          ...
          <div className="option">
            ...
            <SelectBox
              items={itemOrientation === 'vertical' ? verticalDragDirections : horizontalDragDirections}
              value={dragDirection}
          ...
          <div className="option">
            <CheckBox
              text="Use Handle"
              onValueChanged={this.onHandleChanged}
            />
          </div>
          <div className="option">
            <CheckBox
  ...
  onReorder(e) {
    ...
    items = [...items.slice(0, e.toIndex), e.itemData, ...items.slice(e.toIndex)];
